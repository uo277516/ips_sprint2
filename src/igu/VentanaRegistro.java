...
//	}
	...
	public VentanaRegistro(VentanaInscripcion ventanaInscripcion) {
		...
		JLabel lblInfo = new JLabel("Para registrarse, por favor ingrese su DNI, nombre, fecha de nacimiento, email y sexo.\r\n");
	...
	protected void añadirAtleta() {
		...
		at.añadirAtleta(txtDni.getText(), txtNombre.getText(), txtSExo.getText(), txtFecha.getText(), txtEmaiñ.getText());
...
//	    else return false;
	...
	protected boolean checkSexo() {
		if (txtSExo.getText().equals("femenino")) return true;
		else if (txtSExo.getText().equals("masculino")) return true;
		else return false;
//		return true;
	}
